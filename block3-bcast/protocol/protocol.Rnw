...
% TODO Best block sizes for linear/binary.
% TODO: Graphs :(

\subsection{Random Communicators}

Again, results were surprising. Benchmarked times were completely identical to
the ones determined with \lstinline|MPI_COMM_WORLD|.

% TODO: Really? Repeat this.
